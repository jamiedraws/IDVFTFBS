...
<%-- influencer pages were hidden from search results on client site --%>
<% 
List<string> ignorePageCodeList = new List<string> { 
    "tiktok", 
    "emilyk",
    "hoff",
    "brooklynn",
...
if (
    ...
    ignorePageCodeList.Contains(DtmContext.PageCode ?? (DtmContext.Page != null ? DtmContext.Page.PageCode : string.Empty))
) { %>
