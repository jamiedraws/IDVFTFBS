...
<div class="flex">
	<div class="gallery">
		<img id="gallery__main" src="/images/products/3.0000/flawless-brows-home.png" alt="Brows" class="gallery__main">
		<div class="gallery__thumbs">
			<a href="javascript:void(0);" class="no-left-m replace-image"><img src="/images/products/3.0000/flawless-brows-home.png?appV=<%= DtmContext.ApplicationVersion %>" alt=""></a>
			...
			<a href="#flawless-video" class="no-right-m has-fancybox"><img src="/images/products/brows-how-to-video.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt=""></a>
		</div>
	</div>
	<div class="product">
...
<div class="hide" id="flawless-commercial">
	<iframe src="https://player.vimeo.com/video/399987607?title=0&byline=0&portrait=0" width="450" height="254" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
</div>
