...
<%
	...
	<div class="connect u-pad--vert @x3-pad center-text white-background @back-only-hide">
		...
		<div class="width-at-100" style="overflow: hidden;">
			<div id="instafeed" class="animated"></div>
		</div>
	...
	<footer class="l-footer bg-primary tertiary-container o-box--none block u-pad @print-only-hide">
		...
		<nav class="l-footer__in c-brand @mv-u-pad--reset fn--center u-mar--center">
			...
			<img src="/images/3.0000/logo--pink.png?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= SettingsManager.ContextSettings["Label.ProductName"] %>" style="max-width: 204px; display: block; margin: 0 auto 10px;">

			<img src="/images/3.0000/awards-icons.png?appV=<%= DtmContext.ApplicationVersion %>" class="footer__awards center-margin">
	...
	<% switch ( DtmContext.Page.IsStartPageType ) { %>
		...
		<% default: %>
			...
			<% 
                var blogPages = new string[] { "News", "Article" };

                if (!blogPages.Contains(DtmContext.PageCode))
                {
	   ...
	   <% if (DtmContext.PageCode == "ShoppingCart")
        ...
        {%>
            ...
            var feed = new Instafeed({
                get: 'user',
                userId: 1537743608,
                accessToken: '1537743608.7d0313e.5eceb56cabc248479d8e0a8cbb5aa8b6',
                clientId: '',
