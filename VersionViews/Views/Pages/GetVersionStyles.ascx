...
* --------------------------------------------------------------------- */
	...
	@media all and (max-width: 1000px) {
		...
		@media all and ( min-width: 701px ) {
			...
			.dtm .dtm__in .cartTotalQty,
			.dtm .dtm__in .cart-icon {
				display: inline-block;
				width: auto;
				position: relative;
			top: 0;
		...
		@media all and ( max-width: 701px ) {
			...
			.dtm .dtm__in .nav__link--cart {
				padding: 1em 0;
			}
			.dtm .dtm__in .nav__link--cart * {
				display: inline;
			}
			.dtm .dtm__in .nav__link--cart img {
				display: none;
			}
			.l-header .social {
					display: none;
