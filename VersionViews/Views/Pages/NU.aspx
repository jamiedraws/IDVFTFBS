...
<div class="flex">
	<div class="gallery">
		<img id="gallery__main" src="/images/products/NuRazor.png" alt="Nu Razor&trade; Hair Remover" class="gallery__main">
		<div class="gallery__thumbs">
			...
			<a href="#flawless-commercial" class="has-fancybox"><img src="/images/products/3.0000/nu-commercial.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt=""></a>
	...
	<div class="product">
		<h2 class="product__title sans-secondary-bold">Nu Razor&trade; Hair Remover</h2>
		...
		<hr>
         <!--DESCRIPTION HTML -->
				 ...
				 <div class="product__desc sans-secondary-book p">
					...
					<p class="u-mar--vert">
							Nu Razor&trade; Hair Remover is the new revolutionary solution for instant, painless, hair removal. With our bi-directional pivoting head, it's perfect for your most sensitive areas, underarms, ankles and knees. Nu Razor&trade; Hair Remover has an 18-karat gold plated head. No soap, water or creams needed. It's also rechargeable so you can use it anywhere at anytime.<br>
						</p>
			...
			<h2 class="product__title sans-secondary-bold uppercase">Nu Razor&trade; Hair Remover Replacement Heads</h2>
			<p class="u-mar--vert sans-secondary-book p">We recommend replacing the heads of your Nu Razor&trade; Hair Remover unit every 3-6 months. You get a replacement head and SensaGuard Cover!</p>
			<div class="col col__heads--legs">
					<div class="row">
							...
							<div class="col left-padding uppercase sans-secondary-bold">
									<h3 class="product__title__name"><span class="color-tertiary">BEST VALUE!</span></h3>
									<h5>Price: $14.99</h5>
...
<%--								<a href="#order" class="btn--product btn--sold-out sans-primary-medium top-margin">Sold Out</a>--%>
      ...
      %>
			...
			<h2 class="product__title sans-secondary-bold uppercase">Adaptor</h2>
			...
			<div id="faq" class="hide ">
						<p class="bottom-margin sans-secondary-book p"><strong class="block sans-secondary-bold">Can I use Nu Razor&trade; Hair Remover while in the shower or bath?</strong>

					Nu Razor&trade; Hair Remover is designed to perform best as a Dry Shaver. While the unit is water-resistant, it should NEVER get wet or be submerged in water. It is not ideal to use while showering, or on damp or wet skin. Hair is best removed when dry. It comes with SensaGuard Cover for sensitive areas.</p>

				<hr>

						<p class="bottom-margin sans-secondary-book p"><strong class="block sans-secondary-bold"> When should I use the SensaGuard Cover on Nu Razor&trade; Hair Remover, and why? </strong>
				...
				<hr>
					...
					Nu Razor&trade; Hair Remover is a rechargeable unit and takes up to 3-hours to fully charge. The charge will last 60 minutes at full power, with consistent use. NOTE: The unit won't operate while charging. If the unit begins to slow down, clean the head. If still slow, charge unit.</p>
				...
				<hr>
					...
					With Nu Razor&trade; Hair Remover you can shave without the shower, or &ldquo;dry shave&rdquo; anywhere anytime. The results to the naked eye are the same. Legs will appear as clean shaved as with a wet razor. There is, however, a very slight difference in touch as a dry shave will leave a very teeny hair shaft left behind. Again, this is typically invisible to the naked eye, but hair shaft may be felt. Additionally, results typically improve with continued use. The convenience of a dry shave, with a visually clean smooth leg, no nicks, cuts, or irritation, is for most women a desirable alternative to the inconvenience of the wet shave.</p>

						 <hr>

						 <p class="bottom-margin sans-secondary-book p">
				ECO-FRIENDLY | WATERLESS<br>
				Nu Razor&trade; Hair Remover does not require water for use and helps save water consumption.<br>
				Nu Razor&trade; Hair Remover is fully rechargeable, keeping battery acids from leaching into land-fills.<br>
				Nu Razor&trade; Hair Remover is not disposable and is helping keep plastics and blade use to a minimum.
				</p>
								</div>
