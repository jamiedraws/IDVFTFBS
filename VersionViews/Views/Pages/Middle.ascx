...
<%
	...
	var finishingTouch = "Finishing Touch&reg;";
    var flawless = "Flawless&reg;";
    var flawlessBody = flawless + " Body&trade;";
    var flawlessBrows = flawless + " Brows&trade;";
    var flawlessLegs = flawless + " Legs&trade;";
%>
<%
...
<% if ( quotesTitle != null ) { %>
	...
	<div class="width-at-100 reviews">
		<div class="u-pad--vert @x3-pad">
			<h2 class="sans-secondary-semibold center-text uppercase color-gray u-pad--vert @x2-pad fn--expand reviews__title">
...
<div id="story" class="story no-padding">
	...
	<div class="story__text sans-secondary-book color-gray">
	    ...
	    <h3 class="center-text">Be Flawless From Head To Toe&trade;</h3>
    </div>
</div>
</div>
