  ...
  <div class="l-header__in">
    ...
    <div id="mobileMenu" class="header__menu--mobile">
      ...
      <div id="mobileMenuProducts" class="mobile-menu__products">
        <a href="PEDI<%= Model.Extension %>">Flawless Pedi</a>
        <a href="NAILS<%= Model.Extension %>">Flawless Salon Nails</a>
        <a href="SPA<%= Model.Extension %>">Flawless Cleanse Spa</a>
        <a href="PBLUE<%= Model.Extension %>">Flawless </a>
        <a href="BROWPB<%= Model.Extension %>">Flawless Brows </a>
        <a href="CLEANSE<%= Model.Extension %>">Flawless Cleanse</a>
        <a href="NU<%= Model.Extension %>">Flawless Nu Razor</a>
        <a href="GLO<%= Model.Extension %>">Flawless Dermaplane Glo</a>
        <a href="ICE<%= Model.Extension %>">Flawless Ice Roller</a>
        <a href="NFRIG<%= Model.Extension %>">Beauty Fridge</a>
        <a href="CONTOUR<%= Model.Extension %>">Flawless Contour</a>
        <a href="LEGS<%= Model.Extension %>">Flawless Legs</a>
        <a href="MASK<%= Model.Extension %>">Flawless Silk Mask</a>
