...
<div class="flex">
	<div class="gallery">
		...
		<div class="gallery__thumbs">
			...
			<a href="#flawless-commercial" class="has-fancybox"><img src="/images/products/16.0000/flawless-cleanse-commercial.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt=""></a>
...
<%--        <h4 class="product__price u-pad--vert h5 sans-primary-medium">PRICE: $39.99</h4>
		...
		<hr>
				 ...
				 <div class="product__desc sans-secondary-book p">
					...
					<p class="u-mar--vert">
						Flawless Cleanse with its silicone head is an ultra-hygienic cleanser and exfoliator that promotes the appearance of radiant, clean, more youthful skin. Flawless Cleanse has 4 modes, gentle cleansing, pulsating, massage, and deep cleanse for the ultimate facial cleaning experience.<br>
					</p>
