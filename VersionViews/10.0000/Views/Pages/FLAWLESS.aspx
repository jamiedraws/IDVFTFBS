...
<div class="flex">
	<div class="gallery">
		<img id="gallery__main" src="/images/products/10.0000/flawless--color-home.png" alt="Flawless" class="gallery__main">
		<div class="gallery__thumbs">
			<a href="javascript:void(0);" class="no-left-m replace-image"><img src="/images/products/10.0000/flawless--color-home.png?appV=<%= DtmContext.ApplicationVersion %>" alt="Main product"></a>
			...
			<a href="javascript:void(0);" class="replace-image"><img src="/images/products/10.0000/flawless--coral.png?appV=<%= DtmContext.ApplicationVersion %>" alt="Coral"></a>
			<a href="javascript:void(0);" class="replace-image"><img src="/images/products/3.0000/flawless--black.png?appV=<%= DtmContext.ApplicationVersion %>" alt="Black"></a>
		</div>
	</div>
	<div class="product">
