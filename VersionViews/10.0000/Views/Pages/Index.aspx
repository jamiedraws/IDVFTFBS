            ...
            <ul class="js-eflex--fade" data-eflex-delay="7000" data-eflex-slider-type="fade" data-eflex-nav="true">
								...
								<li>
										<a href="NU<%= Model.Extension %>">
											<picture>
												<source media="(min-width: 701px)" srcset="/images/9.0000/glam--nurazor.jpg?appV=<%= DtmContext.ApplicationVersion %>">
												<source media="(max-width: 701px)" srcset="/images/9.0000/glam--nurazor--mobile.jpg?appV=<%= DtmContext.ApplicationVersion %>">
												<img src="/images/9.0000/glam--nurazor.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= flawless %> Nu Razor&trade;">
											</picture>
										</a>
									</li>
              ...
              <a href="FLAWLESS<%= Model.Extension %>"><picture>
                ...
                <li>
						...
						<source media="(min-width: 701px)" srcset="/images/9.0000/glam--brows.jpg?appV=<%= DtmContext.ApplicationVersion %>">
						<source media="(max-width: 701px)" srcset="/images/9.0000/glam--brows--mobile.jpg?appV=<%= DtmContext.ApplicationVersion %>">
						<img src="/images/9.0000/glam--brows.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="Your new brow routine">
					</picture></a>
                </li>
                <li>
                        <a href="CONTOUR<%= Model.Extension %>"><picture>
						<source media="(min-width: 701px)" srcset="/images/9.0000/glam--contour.jpg?appV=<%= DtmContext.ApplicationVersion %>">
						<source media="(max-width: 701px)" srcset="/images/9.0000/glam--contour--mobile.jpg?appV=<%= DtmContext.ApplicationVersion %>">
						<img src="/images/9.0000/glam--contour.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= flawless %> form head to toe">
					</picture></a>
								</li>
								...
								<li>
									<a href="NFRIG<%= Model.Extension %>">
										<picture>
											<source media="(min-width: 701px)" srcset="/images/9.0000/glam--fridge.jpg?appV=<%= DtmContext.ApplicationVersion %>">
											<source media="(max-width: 701px)" srcset="/images/9.0000/glam--fridge--mobile.jpg?appV=<%= DtmContext.ApplicationVersion %>">
											<img src="/images/9.0000/glam--fridge.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= fridge %>">
										</picture>
									</a>
								</li>
                                <li>
									<a href="LEGS<%= Model.Extension %>">
										<picture>
											<source media="(min-width: 701px)" srcset="/images/9.0000/glam--legs.jpg?appV=<%= DtmContext.ApplicationVersion %>">
											<source media="(max-width: 701px)" srcset="/images/9.0000/glam--legs--mobile.jpg?appV=<%= DtmContext.ApplicationVersion %>">
											<img src="/images/9.0000/glam--legs.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= flawlessLegs %>">
										</picture>
									</a>
								</li>
						</ul>
                        ...
                        <div class="option__wrap">
                            <div class="relative center-margin option__img">
                                <a href="FLAWLESS<%= Model.Extension %>" title="See details for <%= flawless %>" class="option__overlay">
                                    <img src="/images/products/10.0000/flawless--color-home.png" alt="Flawless"></a>
                            </div>
                            ...
                            <div class="row row-to-center center-margin bottom-padding">
                                ...
                                <select data-select name="FLAWLESS" class="c-brand--form__select o-box o-shadow u-vw fx--animate">
                                        ...
                                        <option value="CORAL2">Coral</option>
                                    </select>
                            </div>
                            <!-- end price row -->
