                        ...
                        <div class="option__wrap">
                            <div class="relative center-margin option__img">
                                <a href="GLO<%= Model.Extension %>" title="See details for <%= glo %>" class="option__overlay">
                                    <img src="/images/products/3.0000/dermaplane-glo.png" alt="<%= glo %>"></a>
                            </div>
                ...
                <div class="option">
                        <div class="option__wrap">
                            ...
                            <div class="row row-to-center center-margin u-pad--vert center-margin">
                                ...
                                <div class="col">
                                    <a href="#order" title="Add <%= flawless %> to your shopping cart" data-code-toggle="true" data-code="WHITE" class="btn--product h3 sans-primary-medium">Add To Cart</a>
                                </div>
                            </div>
                            <!-- end button row -->
                        </div>
                    ...
                    <div class="option">
                        <div class="option__wrap">
                            ...
                            <div class="row row-to-center u-mar--vert center-margin">
                                ...
                                <div class="col">
                                    <a href="#order" title="Add <%= flawlessLegs %> to your shopping cart" data-code="LEGT" data-select-id="LEGS" data-code-toggle="true" class="btn--product h3 white-text">Add To Cart</a>
                                </div>
                            </div>
                            <!-- end button row -->
                        </div>
