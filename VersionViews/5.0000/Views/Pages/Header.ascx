	...
	<div class="l-header__in">
		...
		<div id="mobileMenu" class="header__menu--mobile">
			...
			<div id="mobileMenuProducts" class="mobile-menu__products">
				<a href="BODY<%= Model.Extension %>"><%= flawlessBody %></a>
				<a href="BROWS<%= Model.Extension %>"><%= flawlessBrows %></a>
				<a href="CONTOUR<%= Model.Extension %>">Flawless&reg; Contour&trade;</a>
				<a href="DERMAPLANE<%= Model.Extension %>"><%= flawlessDermaplane %></a>
				<a href="GLO<%= Model.Extension %>">Dermaplane&trade; Glo</a>
				<a href="FLAWLESS<%= Model.Extension %>"><%= flawlessFace %></a>
				<a href="LEGS<%= Model.Extension %>"><%= flawlessLegs %></a>
			...
			<nav class="menu menu--dd">
				<div class="menu--dd__link">
					...
					<div class="menu--dd__menu">
						<a href="BODY<%= Model.Extension %>"><%= flawlessBody %></a></li>
						<a href="BROWS<%= Model.Extension %>"><%= flawlessBrows %></a></li>
						<a href="CONTOUR<%= Model.Extension %>">Flawless&reg; Contour&trade;</a></li>
						<a href="DERMAPLANE<%= Model.Extension %>"><%= flawlessDermaplane %></a></li>
						<a href="GLO<%= Model.Extension %>"><%= glo %></a></li>
						<a href="FLAWLESS<%= Model.Extension %>"><%= flawlessFace %></a></li>
						<a href="LEGS<%= Model.Extension %>"><%= flawlessLegs %></a></li>
						<a href="REPLACEMENT<%= Model.Extension %>"><%= flawless %> Replacement Heads</a></li>
					</div>
				</div>
				<div class="menu--dd__link">
