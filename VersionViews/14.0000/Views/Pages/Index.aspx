...
<%--                <li>
              ...
              <img src="/images/slides/flawless-cleanse-slide.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= flawlessLegs %>">
                ...
                <li>
                        <picture>
              <source media="(min-width: 701px)" srcset="/images/slides/flawless-slide.jpg?appV=<%= DtmContext.ApplicationVersion %>">
              <source media="(max-width: 701px)" srcset="/images/slides/flawless-slide--mobile.jpg?appV=<%= DtmContext.ApplicationVersion %>">
              <img src="/images/slides/flawless-slide.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= flawless %>">
            </picture>
                </li>
                ...
                <li>
                    <a href="NU<%= Model.Extension %>">
                        <picture>
              <source media="(min-width: 701px)" srcset="/images/6.0000/glam-nurazor.jpg?appV=<%= DtmContext.ApplicationVersion %>">
              ...
              <img src="/images/6.0000/glam--nurazor.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= flawless %> Nu Razor&trade;">
                ...
                <li>
                    <a href="FLAWLESS<%= Model.Extension %>">
                        <picture>
            <source media="(min-width: 701px)" srcset="/images/14.0000/glam--face.jpg?appV=<%= DtmContext.ApplicationVersion %>">
            <source media="(max-width: 701px)" srcset="/images/14.0000/glam--face--mobile.jpg?appV=<%= DtmContext.ApplicationVersion %>">
              ...
              <img src="/images/7.0000/glam-legs.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= flawlessLegs %>">
                ...
                <li>
                    <a href="ICE<%= Model.Extension %>">
                        <picture>
              <source media="(min-width: 701px)" srcset="/images/slides/flawless-ice-slide.jpg?appV=<%= DtmContext.ApplicationVersion %>">
              <source media="(max-width: 701px)" srcset="/images/slides/flawless-ice-slide--mobile.jpg?appV=<%= DtmContext.ApplicationVersion %>">
              <img src="/images/slides/flawless-ice-slide.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= ice %>">
            </picture>
                    </a>
                </li>
            </ul>
