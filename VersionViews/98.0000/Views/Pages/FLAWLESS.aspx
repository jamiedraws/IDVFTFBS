...
<div class="flex">
	<div class="gallery">
		<img id="gallery__main" src="/images/products/16.0000/flawless--color-home.png" alt="Flawless" class="gallery__main">
		<div class="gallery__thumbs">
			<a href="javascript:void(0);" class="no-left-m replace-image"><img src="/images/products/16.0000/flawless--color-home.png?appV=<%= DtmContext.ApplicationVersion %>" alt="Main product"></a>
	...
	<div class="product">
		<h2 class="product__title sans-secondary-bold">Flawless - New and Improved</h2>
