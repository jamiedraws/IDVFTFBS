...
<div class="flex">
	<div class="gallery">
		<img id="gallery__main" src="/images/products/BROWPB-1.jpg" alt="Flawless Brows" class="gallery__main">
		<div class="gallery__thumbs">
			<a href="javascript:void(0);" class="no-left-m replace-image"><img src="/images/products/BROWPB-1.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt=""></a>
			<a href="javascript:void(0);" class="replace-image"><img src="/images/products/flawless-brows-blue.png?appV=<%= DtmContext.ApplicationVersion %>" alt=""></a>
			
			<a href="javascript:void(0);" class="replace-image"><img src="/images/products/flawless-brows.png?appV=<%= DtmContext.ApplicationVersion %>" alt=""></a>
...
<div class="hide" id="flawless-commercial">
	<iframe src="https://player.vimeo.com/video/698360526?title=0&byline=0&portrait=0" width="450" height="254" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
</div>
