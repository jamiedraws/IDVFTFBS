...
<div class="flex">
	<div class="gallery">
		<img id="gallery__main" src="/images/products/BUNCLSE2-1.jpg" alt="Beauty Lover Bundle" class="gallery__main">
		<div class="gallery__thumbs">
			<a href="javascript:void(0);" class="no-left-m replace-image"><img src="/images/products/BUNCLSE2-1.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="Beauty Lover Bundle"></a>
			<a href="javascript:void(0);" class="replace-image"><img src="/images/products/contour.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="Flawless Contour&trade; Facial Roller"></a>
			<a href="javascript:void(0);" class="replace-image"><img src="/images/products/flawless-ice.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="Ice Roller"></a>
	...
	<div class="product">
		<h2 class="product__title sans-secondary-bold">Beauty Lover Bundle</h2>
        <span class="sans-secondary-bold block u-pad--vert">Includes: Flawless Contour&trade; Facial Roller + Ice Roller + Cleanse</span>
