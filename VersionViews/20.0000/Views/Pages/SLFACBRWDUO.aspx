...
<div class="flex">
	<div class="gallery">
		<img id="gallery__main" src="/images/products/SLFACBRWDUO-1.jpg" alt="Flawless" class="gallery__main">
		<div class="gallery__thumbs">
			<a href="javascript:void(0);" class="no-left-m replace-image"><img src="/images/products/SLFACBRWDUO-1.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="Main product"></a>
	...
	<div class="product">
		<h2 class="product__title sans-secondary-bold"><span class="sale-pink">SALE!</span> Facial Hair Remover + Brows - Mermaid</h2>
