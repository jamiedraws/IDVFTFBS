...
<!-- <div class="form-wrapper inner"> -->
    ...
    <div class="center-text">
        ...
        <div class="view">
            <div class="view__anchor" id="vse-errors"></div>
            <span class="vse" data-vse-scroll style="color: #FF0000; font-weight: bold">
        ...
        <div class="o-grid u-vw--100">
                ...
                <div class="c-brand--form__col--left o-grid__col @sm-u-vw--50 @mv-u-mar--vert">
                    ...
                    %>
                    <%-- Account Information --%>
                       <fieldset class="c-brand--form__fieldset">
                           <div class="c-brand--form__legend u-vw--100">
                            <h3 class="c-brand--form__headline fn--ucase">Account Information</h3>
                        </div>
                        <div class="u-pad">
                            <p>Already have an account? <a href="/<%=DtmContext.OfferCode %>/<%=DtmContext.Version %>/Account/Login" class="account__link">Login</a></p>
                        </div>
                    </fieldset>
                    <%
                        }
                    ...
                    <fieldset id="paymentForm" class="c-brand--form__fieldset">
                        ...
                        <ul class="c-brand--form__list u-pad">
                            ...
                            <li id="CardNumberCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="CardNumber" name="CardNumber" type="tel" value="<%= ViewData["CardNumber"] %>" placeholder="#################" aria-labelledby="CardNumberLabel" aria-required="true" class="fld c-brand--form__input o-grid__col o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="cc-number">
                            </li>
                            ...
                            <li id="CardExpirationCt" class="o-grid--vert--center u-vw--100 c-brand--form__item">
                                ...
                                <div class="c-brand--form__field o-grid @xs-u-vw--100 u-bs--reset">
                                    <div class="o-grid__col u-vw--50 u-pad--right">
                                        <%= Html.CardExpirationMonth("CardExpirationMonth", new { @class = "c-brand--form__select o-box o-shadow u-vw--100 u-anim", @autocomplete = "cc-exp-month" }) %>
                                    </div>
                                    <div class="o-grid__col u-vw--50 u-pad--left">
                                        <%= Html.NumericDropDown("CardExpirationYear", DateTime.Now.Year, DateTime.Now.Year + 10, ViewData["CardExpirationYear"], new { @class = "fld c-brand--form__select o-box o-shadow u-vw--100 u-anim", @autocomplete = "cc-exp-year" }) %>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li id="CardCvv2Ct" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <div class="c-brand--form__field o-grid @xs-u-vw--100 u-bs--reset">
                                    <div class="o-grid__col u-vw--50 u-bs--reset u-pad--right">
                                        <input id="CardCvv2" name="CardCvv2" type="tel" value="<%= ViewData["CardCvv2"] %>" maxlength="5" placeholder="CVV2" aria-labelledby="CardCvv2Label" aria-required="true" class="fld c-brand--form__input o-grid__col o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="cc-csc">
                                    </div>
    ...
    <div class="row-to-center u-vw--100">
         <% 
                                            var currentPromo = DtmContext.PromoCodeRules
                                                .Where(p => DtmContext.ShoppingCart.Any(sc => sc.ProductCode == p.PromoCode))
        ...
        <div class="col @mv-u-vw--50 @dv-u-pad--right @mv-u-pad--reset">
            <input type="text" class="ddlPromo u-vw--100 c-brand--form__input o-box o-shadow fx--animate" name="promoCode" id="promoCode" value="<%=currentPromo ?? string.Empty %>">
        </div>
                    ...
                    <fieldset class="snippet--od snippet--od--lg">
                        <div class="snippet--od o-box u-vw--100 u-mar--center" tabindex="0">
                                <div>
                                    ...
                                    <p>60-DAY MONEY BACK GUARANTEE (minus S&amp;H). Sales tax will be added where applicable. A $10 surcharge is added for orders sent to Hawaii and Alaska.</p>
                    ...
                    <fieldset id="billingInformation" class="c-brand--form__fieldset">
                        ...
                        <ul class="c-brand--form__list u-pad">
                            ...
                            <li id="BillingFullNameCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="BillingFullName" maxlength="50" name="BillingFullName" type="text" value="<%= ViewData["BillingFullName"] %>" placeholder="*Full Name:" aria-labelledby="BillingFullNameLabel" aria-required="true" class="fld c-brand--form__input o-grid__col o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-bill billing name">
                            </li>
                            ...
                            <li id="BillingStreetCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <div class="o-grid__col @xs-u-bs--reset @xs-u-vw--70 fld">
                                    <input id="BillingStreet" name="BillingStreet" type="text" value="<%= ViewData["BillingStreet"] %>" maxlength="50" placeholder="Street Address" aria-labelledby="BillingStreetLabel" aria-required="true" class="fld c-brand--form__input o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-bill billing address-line1">
                                </div>
                            </li>
                            ...
                            <li id="BillingStreet2Ct" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="BillingStreet2" name="BillingStreet2" type="text" value="<%= ViewData["BillingStreet2"] %>" maxlength="50" placeholder="Suite / Apt" aria-labelledby="BillingStreet2Label" aria-required="false" class="fld c-brand--form__input o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-bill billing address-line2">
                            </li>
                            ...
                            <li id="BillingCityCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="BillingCity" name="BillingCity" type="text" value="<%= ViewData["BillingCity"] %>" maxlength="50" placeholder="City" aria-labelledby="BillingCityLabel" aria-required="true" class="fld c-brand--form__input o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-bill billing address-level2">
                            </li>
                            ...
                            <li id="BillingCountryCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <%=Html.DropDownListFor(m => m.BillingCountry, new SelectList(Model.Countries, "CountryCode", "CountryName"), new { @class = "fld cartParam shipOptions c-brand--form__select o-grid--col o-box o-shadow @xs-u-vw--100 u-anim", @autocomplete = "section-bill billing country" })%>
                            ...
                            <li id="BillingStateCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <%= Html.DropDownListFor(m => m.BillingState, new SelectList(Model.States, "StateCode", "StateName"), "Choose State", new { @class = "fld shipOptions c-brand--form__select o-grid--col o-box o-shadow @xs-u-vw--100 u-anim", @autocomplete = "section-bill billing address-level1" }) %>
                            </li>
                            ...
                            <li id="BillingZipCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="BillingZip" name="BillingZip" type="tel" value="<%= ViewData["BillingZip"] %>" maxlength="50" placeholder="Zip Code" aria-labelledby="BillingZipLabel" aria-required="true" class="fld c-brand--form__input o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-bill billing postal-code">
                            </li>
                            ...
                            <li id="PhoneCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="Phone" name="Phone" type="tel" value="<%= ViewData["Phone"] %>" maxlength="50" placeholder="###-###-####" aria-labelledby="PhoneLabel" aria-required="true" class="fld c-brand--form__input o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-bill billing phone">
                            </li>
                            ...
                            <li id="EmailCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="Email" name="Email" type="email" value="<%= ViewData["Email"] %>" maxlength="50" placeholder="email@website.com" aria-labelledby="EmailLabel" aria-required="true" class="fld c-brand--form__input o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-bill billing email">
                            </li>
                    ...
                    <fieldset id="shippingInformation" class="c-brand--form__fieldset">
                        ...
                        <ul class="c-brand--form__list u-pad">
                            ...
                            <li id="ShippingFullNameCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="ShippingFullName" name="ShippingFullName" type="text" value="<%= ViewData["ShippingFullName"] %>" maxlength="50" placeholder="*Full Name:" aria-labelledby="ShippingFullNameLabel" aria-required="true" class="fld c-brand--form__input o-grid__col o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-ship shipping name">
                            </li>
                            ...
                            <li id="ShippingStreetCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="ShippingStreet" name="ShippingStreet" type="text" value="<%= ViewData["ShippingStreet"] %>" maxlength="50" placeholder="Street Address" aria-labelledby="ShippingStreetLabel" aria-required="true" class="fld c-brand--form__input o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-ship shipping address-line1">
                            </li>
                            ...
                            <li id="ShippingStreetCt2" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="ShippingStreet2" name="ShippingStreet2" type="text" value="<%= ViewData["ShippingStreet2"] %>" maxlength="50" placeholder="Suite / Apt" aria-labelledby="ShippingStreet2Label" aria-required="false" class="c-brand--form__input o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-ship shipping address-line2">
                            </li>
                            ...
                            <li id="ShippingCityCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="ShippingCity" name="ShippingCity" type="text" value="<%= ViewData["ShippingCity"] %>" maxlength="50" placeholder="City" aria-labelledby="ShippingCityLabel" aria-required="true" class="fld c-brand--form__input o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-ship shipping address-level2">
                            </li>
                            ...
                            <li id="ShippingCountryCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <%=Html.DropDownListFor(m => m.ShippingCountry, new SelectList(Model.Countries, "CountryCode", "CountryName", new { @class = "fld shipOptions c-brand--form__select o-grid--col o-box o-shadow @xs-u-vw--100 u-anim", @autocomplete = "section-ship shipping country" }))%>
                            </li>
                            ...
                            <li id="ShippingStateCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <%= Html.DropDownListFor(m => m.ShippingState, new SelectList(Model.States, "StateCode", "StateName"), "Choose State", new { @class = "fld shipOptions c-brand--form__select o-grid--col o-box o-shadow @xs-u-vw--100 u-anim", @autocomplete = "section-ship shipping address-level1" })%>
                            </li>
                            ...
                            <li id="ShippingZipCt" class="c-brand--form__item o-grid--vert--center u-vw--100">
                                ...
                                <input id="ShippingZip" name="ShippingZip"  type="tel" value="<%= ViewData["ShippingZip"] %>" maxlength="10" placeholder="Zip Code" aria-labelledby="ShippingZipLabel" aria-required="true" class="fld c-brand--form__input o-box o-shadow @xs-u-vw--100 u-anim" autocomplete="section-ship shipping postal-code">
                            </li>
