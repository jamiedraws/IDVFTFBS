...
<div class="flex">
	<div class="gallery">
		<img id="gallery__main" src="/images/products/BUNFACE2-1.jpg" alt="Flawless Hair Be Gone Bundle" class="gallery__main">
		<div class="gallery__thumbs">
			<a href="javascript:void(0);" class="no-left-m replace-image"><img src="/images/products/BUNFACE2-1.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="Flawless Hair Be Gone Bundle"></a>
	...
	<div class="product">
		<h2 class="product__title sans-secondary-bold">Hair Be Gone Bundle</h2>
        <span class="sans-secondary-bold block u-pad--vert">Includes: Facial Hair Remover + Bikini</span>
