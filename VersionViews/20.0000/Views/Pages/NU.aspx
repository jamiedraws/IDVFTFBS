			...
			<div class="col col__heads--legs">
					<div class="row">
							...
							<div class="col left-padding uppercase sans-secondary-bold">
									...
									<a href="#order"  data-modal-dialog-id="customer-cart-status" data-modal-dialog-actor="open" data-modal-dialog-type="document" data-modal-dialog-title="Customer Cart Status"  data-code="NUREP" data-select-id="addon_NUREP" data-code-toggle="true" class="btn--product sans-primary-medium top-margin">add to cart</a>
<%--								<a href="#order" class="btn--product btn--sold-out sans-primary-medium top-margin">Sold Out</a>--%>
							</div>
					</div>
			</div>
