...
<%--			<h2 class="product__title sans-secondary-bold uppercase">Silk Mask<sup>&reg</sup> - Set of 4</h2>
			<div class="col col__heads--legs">
					<div class="row">
							<div class="col">
									<img src="/images/products/masks-thumb.jpg?appV=[#DtmContext.ApplicationVersion#]" alt="Replacement Heads">
							</div>
							<div class="col left-padding uppercase sans-secondary-bold">
									<h5>Price: $29.99</h5>
									<a href="#order" data-code="MASK4" data-select-id="MASK4" data-code-toggle="true" class="btn--product sans-primary-medium top-margin">add to cart</a>--%>
