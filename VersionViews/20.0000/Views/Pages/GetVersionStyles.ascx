...
* --------------------------------------------------------------------- */
		...
		* --------------------------------------------------------------------- */
		.dtm .order-button {
				font: 700 1em/1 'sofia-pro', sans-serif;
				border-radius: 0;
				padding: 0.5rem 5rem;
				border: none;
		...
		.dtm .order-button.uppercase {
			font: 700 1.3em/1 'sofia-pro', sans-serif;
		}
...
* --------------------------------------------------------------------- */
	...
	.sale-pink {color: #f22449;}
		...
		.fb__headline {
				color: white;
				font: 600 20px/1 'sofia-pro', sans-serif;
				text-transform: uppercase;
		}
...
.l-footer .c-list--nav > .o-grid--block a {
		...
		.insta__title {font-family: 'sofia-pro', sans-serif; font-weight: 400; }
		/*
		#instafeed.animated {
...
.flex .product__price-label {
	display: none;
}

.product__price-strike {text-decoration: line-through;}

.product__price-accent {color: #f22449;}
...
.product__review > [data-bv-show] {
	margin-top: 2rem;
}

.product__title + * + .product__review > [data-bv-show] {
	margin-top: 0;
}
...
.product__color--parisianblue,
.product__color--blush {
	position: relative;
}

.product__color--parisianblue::after,
.product__color--blush::after,
.product__color--lavender::after {
	content: "";
	width: 2em;
	height: 2em;
	display: inline-block;
...
#textS {
	...
	font: 500 15px/1 'sofia-pro', sans-serif;
	text-transform: uppercase;
}
...
.form__title {
    font: 600 40px 'sofia-pro', sans-serif;
    color: #333333;
    margin: 35px 0;
}

.form__text {
    font: 400 18px 'sofia-pro', sans-serif;
    color: #333333;
    margin: 15px 0;
}
...
@media all and (max-width: 701px) {
	...
	#dv_Replace .product__heads--main .row > .col .col {
	    width: 100%;
	}

	#dv_Replace .product__heads--main .row-to-top {
		margin: 0;
	}

	#dv_Replace .product__heads--main .row-to-top .col {
		padding: 0;
		display: block;
		width: 100%;
	}
...
/* zoom in on the flawless product when in desktop view */
@media (min-width: 950px) {
    .dtm--pblue .gallery__main.has-zoom {
        overflow: hidden;
        border: 1px solid black;
        position: relative;
        width: 512px; height: 519px;
    }
    .dtm--pblue .gallery__main.has-zoom img {
        border: none;
        transition: transform 0.33s;
    }
    .dtm--pblue .gallery__main.has-zoom:hover img {
        transform: scale(1.6);
        position: absolute;
        top: 140px;
        left: 0px;
...
/* adjustment for minimum video size when opened in fancybox */
