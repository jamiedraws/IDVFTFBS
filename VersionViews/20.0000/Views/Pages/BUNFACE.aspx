...
<div class="flex">
	<div class="gallery">
		<img id="gallery__main" src="/images/products/BUNFACE-1.jpg" alt="Flawless Fabulous Face Bundle" class="gallery__main">
		<div class="gallery__thumbs">
			<a href="javascript:void(0);" class="no-left-m replace-image"><img src="/images/products/BUNFACE-1.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="Flawless Fabulous Face Bundle"></a>
			...
			<a href="javascript:void(0);" class="replace-image"><img src="/images/products/flawless-brows-blue.png?appV=<%= DtmContext.ApplicationVersion %>" alt="Brows"></a>
	...
	<div class="product">
		<h2 class="product__title sans-secondary-bold">Fabulous Face Bundle</h2>
        <span class="sans-secondary-bold block u-pad--vert">Includes: Facial Hair Remover + Brows</span>
