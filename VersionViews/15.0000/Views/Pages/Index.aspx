...
<%--                <li>
                    <a href="CLEANSE<%= Model.Extension %>">
                        <picture>
              <source media="(min-width: 701px)" srcset="/images/slides/flawless-cleanse-slide.jpg?appV=<%= DtmContext.ApplicationVersion %>">
              <source media="(max-width: 701px)" srcset="/images/slides/flawless-cleanse-slide--mobile.jpg?appV=<%= DtmContext.ApplicationVersion %>">
              <img src="/images/slides/flawless-cleanse-slide.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= flawlessLegs %>">
            </picture>
                    </a>
                </li>--%>
              ...
              <img src="/images/15.0000/flawless-slide.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= flawless %>">
            </picture>
                </li>
              ...
              <img src="/images/15.0000/glam--nurazor.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= flawless %> Nu Razor&trade;">
            </picture>
                    </a>
                </li>

                <li>
                    <a href="FLAWLESS<%= Model.Extension %>">
                        <picture>
            <source media="(min-width: 701px)" srcset="/images/15.0000/glam-face.jpg?appV=<%= DtmContext.ApplicationVersion %>">
            <source media="(max-width: 701px)" srcset="/images/15.0000/glam-face--mobile.jpg?appV=<%= DtmContext.ApplicationVersion %>">
            <img src="/images/15.0000/glam-face.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="The new gold standard in hair removal">
          </picture>
                    </a>
                </li>
                <li>
                    <a href="BROWS<%= Model.Extension %>">
                        <picture>
            <source media="(min-width: 701px)" srcset="/images/15.0000/glam-brows.jpg?appV=<%= DtmContext.ApplicationVersion %>">
            <source media="(max-width: 701px)" srcset="/images/15.0000/glam-brows--mobile.jpg?appV=<%= DtmContext.ApplicationVersion %>">
            <img src="/images/15.0000/glam-brows.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="Your new brow routine">
          </picture>
                    </a>
                </li>
                <li>
            ...
            <img src="/images/15.0000/glam-contour.jpg?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= flawless %> form head to toe">
          </picture>
                    </a>
                </li>
