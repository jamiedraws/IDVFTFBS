...
%>
    ...
    <div class="color-gray sans-secondary-book center-text center-margin u-pad--vert @x3-pad shipping--tagline">
        <h2 class="h2"><span class="color-pink--new sans-primary-ultra">FREE SHIPPING</span> on orders $19.99 and up!<sup>*</sup></h2><small>excludes the <%= fridge %></small>
    </div>
            ...
            <div class="options u-pad @x2-pad center-text c-brand--form no-margin">
               ...
               <div class="option">
                    <div class="option__wrap">
                        ...
                        <h4 class="color-gray sans-primary-bold top-padding @x2-pad"><%= NuRazor %>
					</h4>
                        <hr>
                            ...
                            <!-- end button row -->
								...
								<div class="option">
											<div class="option__wrap">
													...
													<h4 class="color-gray sans-primary-bold top-padding @x2-pad"><%= fridge %>
						</h4>
													<hr>
													<div class="row row-to-center center-margin bottom-padding">
															<div class="col right-padding">
																	<h5 class="color-gray sans-primary-medium ">Price: $59.99 + $8.95 P&H</h5>
															</div>
													</div>
													<!-- end price row -->
													<div class="row row-to-center u-pad--vert center-margin">
															...
															<div class="col">
																	<a href="#order" title="Add <%= fridge %> to your shopping cart" data-code="NFRIG" data-code-toggle="true" class="btn--product h3 white-text">Add To Cart</a>
															</div>
													</div>
													<!-- end button row -->
											</div>
