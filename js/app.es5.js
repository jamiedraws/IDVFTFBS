...
/* harmony export */   "initalizeDocumentModalDialogsByDOMMutation": function() { return /* binding */ initalizeDocumentModalDialogsByDOMMutation; }
/* harmony export */ });
/* unused harmony exports allowGlobalAccessModalDialogRepository, initializeDocumentModalDialogsByControllers, initializeDocumentModalDialogsByContainers */
...
/* harmony export */ });
/* unused harmony exports appendElement, getJSONByElementAttribute */
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "../../node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "../../node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__);
...
/***/ "./ts/api/html-template-rendering-engine.ts":
/*!**************************************************!*\
  !*** ./ts/api/html-template-rendering-engine.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initializeGlobalHTMLTemplateRenderingEngine": function() { return /* binding */ initializeGlobalHTMLTemplateRenderingEngine; }
/* harmony export */ });
...
/* harmony import */ var Shared_ts_utils_html__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! Shared/ts/utils/html */ "../../Shared-International/ts/utils/html.ts");
...
var HTMLTemplateRenderingEngine = /*#__PURE__*/ function () {
    /**
     ...
     */
    function HTMLTemplateRenderingEngine() { }
    /**
     ...
     */
    var _proto = HTMLTemplateRenderingEngine.prototype;
    _proto.renderViewByTemplate = function renderViewByTemplate(template, data) {
        if (!template)
            return;
        var html = template.innerHTML;
        var fragment = (0,Shared_ts_utils_html__WEBPACK_IMPORTED_MODULE_15__.renderTemplate)(html);
        var treeWalker = document.createTreeWalker(fragment, NodeFilter.SHOW_TEXT, null, false);
        var currentNode = treeWalker.nextNode();
        while (currentNode) {
            var _currentNode$textCont, _currentNode$textCont2;
            var textContentReference = (_currentNode$textCont = (_currentNode$textCont2 = currentNode.textContent) == null ? void 0 : _currentNode$textCont2.trim()) != null ? _currentNode$textCont : "";
            var matches = textContentReference == null ? void 0 : textContentReference.matchAll(/{{(\w*)}}/g);
            var textContentGenerator = textContentReference;
            for (var _iterator = _createForOfIteratorHelperLoose(matches), _step; !(_step = _iterator()).done;) {
                var _textContentGenerator;
                var match = _step.value;
                var token = match[0];
                var key = match[1];
                var value = data[key];
                var tag = "<span data-template-key=\"" + key + "\">" + value + "</span>";
                textContentGenerator = (_textContentGenerator = textContentGenerator) == null ? void 0 : _textContentGenerator.replace(token, tag);
            }
            currentNode.textContent = textContentGenerator;
            currentNode = treeWalker.nextNode();
        }
        return HTMLTemplateRenderingEngine.processFragmentWithEncodedHTML(fragment);
    };
    HTMLTemplateRenderingEngine.processFragmentWithEncodedHTML = function processFragmentWithEncodedHTML(fragment) {
        var encodedHTMLString = HTMLTemplateRenderingEngine.convertFragmentToEncodedString(fragment);
        var decodedHTMLString = HTMLTemplateRenderingEngine.decodeHTMLString(encodedHTMLString);
        return (0,Shared_ts_utils_html__WEBPACK_IMPORTED_MODULE_15__.renderTemplate)(decodedHTMLString);
    };
    HTMLTemplateRenderingEngine.convertFragmentToEncodedString = function convertFragmentToEncodedString(fragment) {
        this.div.appendChild(fragment);
        return this.div.innerHTML;
    };
    HTMLTemplateRenderingEngine.decodeHTMLString = function decodeHTMLString(encodedString) {
        this.textarea.innerHTML = encodedString;
        return this.textarea.value;
    };
    HTMLTemplateRenderingEngine.mapAttributeKeysToDataKeys = function mapAttributeKeysToDataKeys(element, data) {
        var elements = Array.from(element.querySelectorAll("[data-template-key]"));
        elements.forEach(function (element) {
            var key = element.getAttribute("data-template-key");
            if (!key)
                return;
            var value = data[key];
            if (!value || value === "")
    ...
    _proto.renderViewByFragment = function renderViewByFragment(fragment, data) {
        if (!fragment)
            return;
        return HTMLTemplateRenderingEngine.mapAttributeKeysToDataKeys(fragment, data);
    };
    _proto.renderViewByElement = function renderViewByElement(element, data) {
        if (!element)
            return;
        return HTMLTemplateRenderingEngine.mapAttributeKeysToDataKeys(element, data);
    };
 ...
 */
HTMLTemplateRenderingEngine.textarea = document.createElement("textarea");
HTMLTemplateRenderingEngine.div = document.createElement("div");

var initializeGlobalHTMLTemplateRenderingEngine = function initializeGlobalHTMLTemplateRenderingEngine() {
    var htmlTemplateRenderingEngine = new HTMLTemplateRenderingEngine();
...
/*!*******************!*\
  !*** ./js/app.ts ***!
  \*******************/
/* harmony import */ var Shared_ts_applications_modal_dialog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Shared/ts/applications/modal-dialog */ "../../Shared-International/ts/applications/modal-dialog.ts");
/* harmony import */ var ts_api_html_template_rendering_engine__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ts/api/html-template-rendering-engine */ "./ts/api/html-template-rendering-engine.ts");


(0,Shared_ts_applications_modal_dialog__WEBPACK_IMPORTED_MODULE_0__.initializeDocumentModalDialogsByTemplates)();
(0,Shared_ts_applications_modal_dialog__WEBPACK_IMPORTED_MODULE_0__.initalizeDocumentModalDialogsByDOMMutation)();
(0,ts_api_html_template_rendering_engine__WEBPACK_IMPORTED_MODULE_1__.initializeGlobalHTMLTemplateRenderingEngine)();
